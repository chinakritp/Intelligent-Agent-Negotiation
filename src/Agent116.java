...
public class Agent116 extends AbstractNegotiationParty {
        private final String description = "YourAgentsNameHere : Agent101";
    ...
    public void Calculate_LeastAcceptableBidUtility(double mid_size)
    {
        ...
        if (sizeIssues > 0)
        {
            ...
            // double mid_size = 10;
            double xx = (sizeIssues - 5)*6*(1/(mid_size-1));
    ...
    public Bid generateRandomBidWithUtilityBand(double utilityFloor,double utilityCeil) {
        ...
        while ( (utility < utilityFloor) || (utility > utilityCeil) );
        return randomBid;
    }
    ...
    //**** Initial part of the Agent ****//
        ...
        public Action chooseAction(List<Class<? extends Action>> list) {
            ...
            double midsize = 2+(sizeIssues*time);
            ...
            if (lastReceivedOffer != null
                    ...
                    && this.utilitySpace.getUtility(lastReceivedOffer) >= this.utilitySpace.getUtility(prevReceivedOffer)) {
